...
* [`4.4`, `4.4-debian-10`, `4.4.14`, `4.4.14-debian-10-r33` (4.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.4.14-debian-10-r33/4.4/debian-10/Dockerfile)
* [`4.2`, `4.2-debian-10`, `4.2.20`, `4.2.20-debian-10-r32` (4.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.20-debian-10-r32/4.2/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/mongodb:latest 'https://github.com/bitnami/bitnami-docker-mongodb.git#master:5.0/debian-10'
```
